 ...
 */
public class OnPageFirstHotAdapter extends BaseAdapter{
    ...
    public OnPageFirstHotAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.onepageframent_hot_listview_adapter_item, null);
