 ...
 */
public class SearchAtyLvAdp extends BaseAdapter{

    private SearchAtyBean bean;

    private ArrayList<String> arrayList;
    private Context context;
    public int i = 1;

    public SearchAtyLvAdp(Context context) {
        this.context = context;
    }

    public void setBean(SearchAtyBean bean) {
        this.bean = bean;
    ...
    public void clear(int i) {
        ...
        if(1 == i){
            ...
            bean.getResult().getWordlist().clear();
        }
