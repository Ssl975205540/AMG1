 ...
 */
public class OnPageLvAdp extends BaseAdapter{

    private OnePageFgtBean bean;

    private Context context;

    public OnPageLvAdp(Context context) {
        this.context = context;
    }

    public void setBean(OnePageFgtBean bean) {
        this.bean = bean;
    }
    ...
    public void setBean1(OnePageFgtBean bean1) {
