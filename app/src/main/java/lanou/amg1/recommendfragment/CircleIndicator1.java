...
import lanou.amg1.R;
import lanou.amg1.guidepoint.ShapeHolder;
...
public class CircleIndicator1 extends View {
    ...
    public void setViewPager(final ViewPager viewPager, ArrayList<ImageView> imageViews){

        this.imageViews = imageViews;
        this.viewPager = viewPager;
        createTabItems(imageViews);
        createMovingItem();
        setUpListener();
    }
        ...
        viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if(mIndicatorMode != Mode.SOLO){
                    ...
                    Log.d("CircleIndicator1", "positionOffset:" + positionOffset);

                        Log.d("CircleIndicator1", "ffffff");
                        trigger(position%(imageViews.size()-1), positionOffset);
            ...
            public void onPageSelected(int position) {
                ...
                if(mIndicatorMode == Mode.SOLO){
                    trigger(position%(imageViews.size()-1),0);
                }
            }
        });
    }
    ...
    private void createTabItems(ArrayList<ImageView> imageViews) {
    ...
    private void layoutMovingItem(final int position,final float positionOffset){
        ...
        ShapeHolder item = tabItems.get(position%imageViews.size());
