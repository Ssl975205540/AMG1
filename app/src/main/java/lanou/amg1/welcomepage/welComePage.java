...
public class welComePage extends FragmentActivity {
    ...
    private WelComePageViewPagerAdapter _welComePageViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _welComePageViewPagerAdapter = new WelComePageViewPagerAdapter();
        ...
        _welComePageViewPagerAdapter.setArrayList(arrayList);

        viewPager_WelComePage.setAdapter(_welComePageViewPagerAdapter);
